...
//======================================================================
    ...
    app.get('/index_questions', function(req, res) {
        console.log("req.body in index_quesitons route:",req.body);
        questions.display_all(req, res)
    })

    //*** Create a new product
    app.post('/new_question', function(req, res){
        console.log("req.body in new_question route",req.body);
